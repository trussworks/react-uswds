...
export const CollectionMetaItemForwardRef: React.ForwardRefRenderFunction<
  HTMLLIElement,
  CollectionMetaItemProps
...
const CollectionMetaItem = forwardRef(CollectionMetaItemForwardRef)
