...
import SummaryBoxBase from './SummaryBoxBase'
...
describe('SummaryBox component', () => {
  it('renders without errors', () => {
    const { getByTestId } = render(
      <SummaryBoxBase>{testSummaryBoxContent}</SummaryBoxBase>
    )
  ...
  it('renders attributes passed in through props', () => {
    const { queryByTestId } = render(
      <SummaryBoxBase {...customProps}>{testSummaryBoxContent}</SummaryBoxBase>
    )
