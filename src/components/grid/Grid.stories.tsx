...
type CustomGridProps = React.JSX.IntrinsicElements['li']
...
type CustomGridContainerProps = React.JSX.IntrinsicElements['ul']

const CustomGridContainer: React.FunctionComponent<
  CustomGridContainerProps
> = ({ children, className, ...ulProps }: CustomGridContainerProps) => (
...
export const CardLgContainer: Story = {
  render: () => (
