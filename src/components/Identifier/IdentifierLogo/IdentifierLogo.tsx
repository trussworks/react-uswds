...
export const IdentifierLogoForwardRef: React.ForwardRefRenderFunction<HTMLAnchorElement, IdentifierLogoProps> = ({
  children,
  className,
  ...anchorProps
...
export const IdentifierLogo = forwardRef(IdentifierLogoForwardRef)
