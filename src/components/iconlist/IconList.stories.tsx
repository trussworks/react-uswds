      ...
      <IconListItem>
        ...
        <IconListContent>
          ...
          <p>
            ...
            are the fastest, most flexible and most effective method of
            donating. Organizations on the ground know what items and quantities
            are needed, often buy in bulk with discounts and, if possible,
            purchase through businesses local to the disaster, which supports
            economic recovery.
          </p>
        </IconListContent>
      </IconListItem>
...
export const CustomSizeWithRichContent: Story = {
  render: () => (
    <>
      <p className="margin-bottom-2">
        ...
        <IconListItem>
          ...
          <IconListContent>
            ...
            <p>
              ...
              sunlight can also lift your mood to help brighten your day. On
              warm days, close your curtains to help keep your house cool.
            </p>
          </IconListContent>
        </IconListItem>
        <IconListItem>
