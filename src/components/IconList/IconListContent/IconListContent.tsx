...
export const IconListContentForwardRef: React.ForwardRefRenderFunction<HTMLDivElement, IconListContentProps> = ({
  className,
  children,
  ...divProps
}, ref): ReactElement => {
  ...
  return (
    <div ref={ref} className={classes} {...divProps} data-testid="iconListContent">
      {children}
    </div>
  )
}
