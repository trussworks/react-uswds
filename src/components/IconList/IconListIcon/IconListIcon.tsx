...
export const IconListIconForwardRef: React.ForwardRefRenderFunction<HTMLDivElement, IconListIconProps> = ({
  className,
  children,
  ...divProps
}, ref): ReactElement => {
...
export const IconListIcon = forwardRef(IconListIconForwardRef)
