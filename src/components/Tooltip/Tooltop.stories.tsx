...
export const tooltipDefault = (): React.ReactElement => <Tooltip label="tooltip">
  <button type="button" className="usa-button usa-tooltip__trigger" title="Bottom">Show default</button>
</Tooltip>
