...
export const MultipleSignInOptions: Story = {
  render: () => {
    return (
      <>
                  ...
                  <div className="bg-white padding-y-3 padding-x-5 border border-base-lighter">
                    ...
                    <div className="usa-prose">
                      <p className="margin-top-1">
                        You can access your account by signing in with one of
                        the options below.
                      </p>
                    </div>
                  ...
                  <div className="border-top border-base-lighter padding-top-4 desktop:border-0 desktop:padding-top-0">
                    ...
                    <div className="usa-prose">
                      <p>
                        ...
                        easily scannable bullet points. Note that on mobile,
                        this text block will bump below the Create Account form.
                      </p>
                      <section className="usa-graphic-list">
                        <div className="usa-graphic-list__row">
                          {Array.from(Array(3), (_, idx) => (
                            <div
                              className="usa-media-block margin-y-2"
                              key={idx}>
                              <img
                    ...
                    <div className="border-top border-base-lighter margin-top-3 padding-top-1">
                      ...
                      <div className="usa-prose">
                        <p>
                          If you are a federal employee or [other secondary
                          user], please use [secondary Single Sign On (SSO)].
                        </p>
