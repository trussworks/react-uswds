...
export const TypeStyles: Story = {
  render: () => (
    <div className="grid-container">
      ...
      <hr />
      <p>
        Ut voluptatum quia quidem. Et et numquam architecto. Consequuntur enim
        ex labore cumque rerum voluptatem dolor. Vero asperiores consequatur
      ...
      <h3>Accent cool</h3>
      <p className="text-accent-cool-lighter bg-ink">
